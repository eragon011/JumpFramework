...
public class Databases extends ViewPart {
	...
	*/
	public void createPartControl(Composite parent) {
		...
		//lblConfiguration.setBackground(SWTResourceManager.getColor(SWT.TRANSPARENT));
		
		Label lblTable = new Label(parent, SWT.NONE);
		lblTable.setText("Table");
		//lblTable.setBackground(SWTResourceManager.getColor(SWT.TRANSPARENT));
		...
		lblDatabaseName.setBackground(SWTResourceManager.getColor(SWT.TRANSPARENT));
		...
		lblDatabaseUser.setBackground(SWTResourceManager.getColor(SWT.TRANSPARENT));
		...
		lblDatabasePassword.setBackground(SWTResourceManager.getColor(SWT.TRANSPARENT));
